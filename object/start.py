...
import sys
from object.const import HEIGHT, WHITE, WIDTH
...
class Start:
    ...
    def init(self):
        ...
        # màu nút và font của chế độ chơi
        color_light = (164, 108, 241)
        color_dark = (79, 47, 153)
        mode_font = pygame.font.SysFont('Corbel',20)
        
        # văn bản hiển thị chế độ chơi
        ...
        while True:
            ...
            mouse = pygame.mouse.get_pos() # lưu tọa độ (x, y) vào biến dưới kiểu tuple
